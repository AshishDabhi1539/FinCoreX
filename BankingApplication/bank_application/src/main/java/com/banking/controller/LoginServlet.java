            ...
            switch (status) {
                ...
                case "ACTIVE":
                    ...
                    if ("ADMIN".equalsIgnoreCase(user.getRole())) {
                        request.setAttribute("success", "🎉 Welcome back, " + user.getFullName() + "! You have successfully logged in as Administrator.");
                        response.sendRedirect(request.getContextPath() + "/admin/dashboard");
                    } else {
                        request.setAttribute("success", "🎉 Welcome back, " + user.getFullName() + "! You have successfully logged in to your account.");
