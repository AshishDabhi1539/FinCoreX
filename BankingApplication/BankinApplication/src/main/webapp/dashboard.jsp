...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 sidebar">
            ...
            <a href="<%=request.getContextPath()%>/dashboard.jsp"><i class="fas fa-home"></i> Dashboard</a>
            <a href="<%=request.getContextPath()%>/customers.jsp"><i class="fas fa-users"></i> All Customers</a>
            <a href="<%=request.getContextPath()%>/pending.jsp"><i class="fas fa-clock"></i> Pending Approvals</a>
            <a href="<%=request.getContextPath()%>/create-user.jsp"><i class="fas fa-user-plus"></i> Create User</a>
            <a href="<%=request.getContextPath()%>/account-management.jsp"><i class="fas fa-credit-card"></i> Account Management</a>
            <a href="<%=request.getContextPath()%>/loan-management.jsp"><i class="fas fa-money-bill-wave"></i> Loan Management</a>
            <a href="<%=request.getContextPath()%>/transactions.jsp"><i class="fas fa-exchange-alt"></i> Transactions</a>
            <a href="<%=request.getContextPath()%>/reports.jsp"><i class="fas fa-chart-bar"></i> Reports & Analytics</a>
            <hr class="my-3">
            <a href="<%=request.getContextPath()%>/search.jsp"><i class="fas fa-search"></i> Search Users</a>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3 mb-2">
                                    <a href="<%=request.getContextPath()%>/pending.jsp" class="btn btn-warning btn-sm w-100">
                                        <i class="fas fa-clock"></i> Review Pending
                                    </a>
                                </div>
                                <div class="col-md-3 mb-2">
                                    <a href="<%=request.getContextPath()%>/create-user.jsp" class="btn btn-primary btn-sm w-100">
                                        <i class="fas fa-user-plus"></i> Create User
                                    </a>
                                </div>
                                <div class="col-md-3 mb-2">
                                    <a href="<%=request.getContextPath()%>/reports.jsp" class="btn btn-info btn-sm w-100">
                                        <i class="fas fa-chart-bar"></i> View Reports
                                    </a>
                                </div>
                                <div class="col-md-3 mb-2">
                                    <a href="<%=request.getContextPath()%>/transactions.jsp" class="btn btn-success btn-sm w-100">
